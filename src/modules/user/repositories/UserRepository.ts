...
class UserRepository {
            ...
            hash(password, 10, (err, hash) => {
                ...
                connection.query(
                    ...
                    (error: any, result: any, fields: any) => {
                        ...
                        response.status(200).json({success: true, message: 'Usuário criado com sucesso'})
                    }
                )   
            })
        })
    ...
    getUser(request: Request, response: Response) {
        const decode: any = verify(request.headers.authorization as any, process.env.SECRET as string);
